        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                <div class="text-center">
                    <h4 class="mb-0">Existem Tabelas Relacionadas</h4><br>
                    <fieldset>
                          ...
                          <thead>
                            <tr>
                              <?php
								...
								} else echo "</thead><tbody><tr><td>Nenhuma relação encontrada</td></tr>";
                            ?>
                                </tbody>
                                </table> 
                <div class="text-center">
                    <h4 class="mb-0">Adicionar nova relação</h4><br>
                      <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
<?php
...
<form method="post" action="tables.php">
    <button type="submit" id="singlebutton" name="singlebutton" class="btn btn-success">Continuar para CRUD</button>
</form>     
</section>
