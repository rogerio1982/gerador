        ...
        <div class="container bg-white shadow py-5">
            ...
            <div class="col-md-12 mx-auto">
                    <div class="text-center mb-4">
                        <h4 class="h1 border-bottom pb-2">Todas as Tabelas</h4>
                    </div>
                    ...
                    <form class="form-horizontal" action="columns.php" method="post">
                        ...
                        '<div class="row align-items-center">
                            ...
                            <div class="col-md-3">
                              <input class="mr-1" type="checkbox"  name="table['.$i.'][tablecheckbox]" id="checkboxes-'.$i.'" value="1"><label for="checkboxes-'.$i.'">Gerar CRUD</label>
                            </div>
                        </div>
                        ';
                            ...
                            <div class="row">
                                <div class="col-md-6 mx-auto">
                                    ...
                                    <button type="submit" id="singlebutton" name="singlebutton" class="btn btn-success btn-block shadow rounded-0">Selecionar as tabelas</button>
                                </div>
                            </div>
                        </fieldset>
                    </form>
