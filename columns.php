        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                <div class="text-center">
                    <h4 class="h1 border-bottom pb-2">Todas as colunas</h4>
                </div>
                    ...
                    <fieldset>
                        ...
                        if ( isset( $_POST['table'] ) )
                        {
                            foreach ( $_POST['table'] as $table )
                            {
                                ...
                                <label for="checkboxes-'.$checked_tables_counter.'-'.$i.'">Visível??</label></div>
                     </div>';
                                        $i++;
                                    }
                            ...
                            <div class="col-md-8 mx-auto">
                                <p class="form-check">
                                    ...
                                    <label class="form-check-label" for="keep_startpage">
                                        Manter a página inicial e as páginas CRUD geradas anteriormente??
                                    </label>
                                    <br>
                                    ...
                                    <label class="form-check-label" for="append_links">
                                        Anexar novos links à página inicial gerada anteriormente, se necessário <?php echo $checked_tables_counter > 1 ? 's' : '' ?>
                                    </label>
                                </p>
                            </div>
                            <div class="col-md-8 mx-auto">
                                <button type="submit" id="singlebutton" name="singlebutton" class="btn btn-success btn-block rounded-0 shadow-sm">Gerar app</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
