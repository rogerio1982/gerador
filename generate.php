    ...
    <div class="container bg-white py-5 shadow">
        <div class="row">
            <div class="col-md-12 mx-auto px-5">
                <?php generate($_POST); ?>
                <hr>
                <br>Seu app foi criado!<br><br>
                <a href="app/index.php" target="_blank" rel="noopener noreferrer">Acesse seu app</a> <br><br>
                <hr>
                site: <a href="http://cruddiy.com">cruddiy.com</a>
