            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">{TABLE_DISPLAY} Detalhes</h2>
                        <a href="{TABLE_NAME}-create.php" class="btn btn-success float-right">Inserir</a>
                        <a href="{TABLE_NAME}-index.php" class="btn btn-info float-right mr-2">Limpar</a>
                        <a href="index.php" class="btn btn-secondary float-right mr-2">Voltar</a>
                    </div>
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    {INDEX_TABLE_ROWS}
                                        echo "<td>";
                                            ...
                                            echo "<a href='{TABLE_NAME}-update.php?{COLUMN_ID}=". $row['{COLUMN_NAME}'] ."' title='Atualizar' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='{TABLE_NAME}-delete.php?{COLUMN_ID}=". $row['{COLUMN_NAME}'] ."' title='Apagar' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
...
?>
                                ...
                                <?php
                                 ...
                                 ?>
                                    <li class="page-item"><a class="page-link" href="<?php echo $new_url .'&pageno=1' ?>">Primeiro</a></li>
                                    <li class="page-item <?php if($pageno <= 1){ echo 'disabled'; } ?>">
                                        <a class="page-link" href="<?php if($pageno <= 1){ echo '#'; } else { echo $new_url ."&pageno=".($pageno - 1); } ?>">Voltar</a>
                                    </li>
                                    <li class="page-item <?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
                                        <a class="page-link" href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo $new_url . "&pageno=".($pageno + 1); } ?>">Próxima</a>
                                    </li>
                                    <li class="page-item <?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
...
if(isset($_GET["{TABLE_ID}"]) && !empty($_GET["{TABLE_ID}"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            echo "Tente novamente!<br>".$stmt->error;
        }
    }
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 mx-auto">
                    ...
                    <p><a href="{TABLE_NAME}-index.php" class="btn btn-primary">Voltar</a></p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        <div class="alert alert-danger fade-in">
                            ...
                            <p>Deseja apagar?</p><br>
                            <p>
                                <input type="submit" value="Sim" class="btn btn-danger">
                                <a href="{TABLE_NAME}-index.php" class="btn btn-secondary">Não</a>
                            </p>
                        </div>
                    </form>
                </div>
