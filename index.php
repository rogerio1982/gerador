            ...
            <form class="form-group-row" action="relations.php" method="post">
                <fieldset>
                    ...
                    <div class="text-center pt-5">
                        <h4>Entre com as informações do banco de dados</h4>
                    </div>

                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-form-label" for="textinput">Servidor</label>
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-form-label" for="textinput">Usuário</label>
                    ...
                    <!-- Password input-->
                    <div class="form-group">
                        <label class="col-form-label" for="passwordinput">Senha</label>
                    ...
                    <div class="form-group">
                        <label class="col-form-label" for="recordsperpage">Items por página</label>
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-form-label" for="textinput">Nome App</label>
                    ...
                    <div class="form-group">
                        ...
                        <button id="index" name="index" class="btn btn-primary">Enviar</button>
                    </div>
                </fieldset>
            </form>
        </div>
